...
class HealthAdapter(context: Context,private val delegate:HealthActionDelegates):BaseRecyclerAdapter<HealthViewHolder,HealthVO> (context) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HealthViewHolder {
        ...
        return HealthViewHolder(healthViewItem,delegate)
    }
